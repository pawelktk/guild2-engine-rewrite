...
auto GuildObject_GetHPRelative = reinterpret_cast<float(__fastcall *)(void *this_ptr)>(0x0062e700);

int __cdecl GetHPRelative(lua_State *L) {
  ScriptManager_InitDebugInfo_magic(L, ".\\SourceCode\\GuildGameObjectsScript\\GuildGameScriptBinding.cpp", 12026, 1);
